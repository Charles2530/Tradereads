  ...
  <div class="all">
    ...
    <div class="zhu">
      ...
      <div class="info">
        ...
        <div class="sellname11">
          发货人信息：{{ seller_name }} &nbsp;&nbsp;&nbsp;&nbsp;
          {{ seller_phone }}
        </div>
        <div class="capcity11">{{ product_state }}</div>
        <div class="add1" @click="count++"></div>
        <div class="count1">{{ count }}</div>
        <div class="sub1" @click="count > 0 ? count-- : count"></div>
        <button class="bought1" @click="buything">
          购&nbsp;&nbsp;&nbsp;&nbsp;买
        </button>
        <button class="addbought1" @click="addshop">加入购物车</button>
      </div>
    </div>
    <div class="comment">
      <div class="fivestar">
      ...
      <div
        v-for="comms in comments.value"
        :key="comms.product_id"
        class="com_sub"
      >
        <div class="comname">
          {{ comms.user_id }}
        ...
        <div class="commain">
          <!-- <div class="star"></div> -->
          <div class="star">
            <span v-for="s in comms.score" :key="s"></span>
          </div>
